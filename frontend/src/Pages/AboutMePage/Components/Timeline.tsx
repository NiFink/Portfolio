...
export default function Timeline({ defaultColor }: TimelineProps) {
  return (
    <div className="my-16 flex flex-col gap-20 text-white">
        ...
        return (
          ...
          >
            ...
            <div className="hidden items-start w-44 pt-0.5 relative sm:flex">
              ...
              <div className="bg-black w-px h-[80%] translate-x-5 translate-y-16 opacity-30"></div>
              <i
                className={`${
                  element.icon === "school"
              ...
              ></i>
              <div className="bg-slate-900 h-px w-8 mx-2 translate-y-6 opacity-30"></div>
            </div>

            <div className="border border-gray-600 rounded-lg px-8 py-4 bg-gray-800 w-full text-center z-10 sm:w-96 relative">
              ...
              <div className="flex flex-wrap mb-6 justify-center">
                {element.tech.map((tech, index) => (
                  <span key={index} className="bg-gray-900 rounded-xl px-2 py-1 text-sm m-1">
                    {tech}
                  </span>
                ))}
              </div>
